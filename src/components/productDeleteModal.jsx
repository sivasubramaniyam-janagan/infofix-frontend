...
export default function ProductDeleteModel(props){
    ...
    return (
        <>
        <button className="p-2 bg-red-400 hover:bg-red-950 text-white flex justify-center items-center p-1 w-20 rounded-[10px]" onClick={()=>{setIsModalOpen(true)}}><IoTrashBinSharp /></button>
        {
        isModalOpen && <div className="w-screen h-screen bg-black/40 fixed top-0 left-0 flex items-center justify-center ">
            <div className="w-[450px] h-[250px] bg-primary rounded-2xl flex flex-col justify-center items-center p-4 text-black text-2xl">
                ...
                <div className="flex justify-between w-full pl-9 pr-9 mt-3.5">
                    <button className="bg-red-500 hover:bg-red-950 p-1.5 w-24 rounded-sm flex items-center text-white justify-center"onClick={handleDelete}><IoTrashBinSharp /></button>
                    <button className="bg-gray-500 flex items-center justify-center hover:bg-gray-900 p-1.5 w-24 rounded-sm text-white"onClick={()=>{setIsModalOpen(false)}}><MdCancel /></button>
